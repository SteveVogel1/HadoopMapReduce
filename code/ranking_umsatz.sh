...
$HADOOP_PREFIX/bin/hadoop jar team1MapReduce.jar team1MapReduce.UmsatzRanking_2 map-reduce-assignment/output/GroupByUmsatz_1/part-r-* map-reduce-assignment/output/UmsatzRanking_2
